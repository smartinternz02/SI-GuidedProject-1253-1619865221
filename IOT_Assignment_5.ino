...
const char* ssid = "Pavani Reddy";
const char* password = "Pavanikk";
...
void loop(){
  ...
  if (client) {                             // If a new client connects,
    ...
    http.begin("api.openweathermap.org/data/2.5/weather?q=Hyderabad,IN&appid=1004ffe380046bb2c9cca521699b66d8"); 
